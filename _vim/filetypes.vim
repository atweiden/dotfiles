...
au BufEnter,BufRead,BufNewFile,BufWrite {*.erl,*.es,*.hrl,*.xrl,*.yaws,rebar.config} set ft=erlang
...
au BufEnter,BufRead,BufNewFile,BufWrite {*.js,*.jsm,*.jss,*.jsx,Jakefile} set ft=javascript
au BufEnter,BufRead,BufNewFile,BufWrite {*.json,*.jsonp,.eslintrc,.jshintrc,.jsxhintrc} set ft=json
...
au BufEnter,BufRead,BufNewFile,BufWrite {*.p6,*.pm6,*.t6,*.nqp} set ft=perl6
