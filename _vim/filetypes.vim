...
au BufEnter,BufRead,BufNewFile,BufWrite {*.js,*.jss,*.tag,.jshintrc} set ft=javascript
...
au BufEnter,BufRead,BufNewFile,BufWrite {*.rb,*.god,*.rabl,.caprc,.irbrc,Capfile,Gemfile,Puppetfile,Rakefile,Thorfile,config.ru,irb_tempfile*} set ft=ruby
